...
public class WindowFormTransaksi extends JFrame {
	...
	public WindowFormTransaksi(Core core) {
		...
		panTable.setBounds(10, 10, 420, 300);
		panTable.setBackground(Color.WHITE);
		panGrand = new JPanel(null);
		panGrand.setBackground(SystemColor.inactiveCaption);
		panGrand.setBounds(0, 0, 450, 330);
		panLeft = new JPanel(null);
		panLeft.setBackground(SystemColor.activeCaption);
		panLeft.setBounds(445, 0, 269, 330);
		...
		tfTgl.setBounds(89, 11, 170, 20);
		tfKasir.setBounds(89, 36, 170, 20);
		cb.setBounds(89, 61, 170, 20);
		tfHarga.setBounds(89, 86, 170, 20);
		tfJumlah.setBounds(89, 111, 170, 20);
		...
		btnTambahBarang.setBounds(89, 142, 80, 20);
		...
		btnTambahTransaksi = new JButton("Print");
		btnTambahTransaksi.setBounds(179, 142, 80, 20);
