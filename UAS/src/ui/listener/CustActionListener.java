...
public class CustActionListener implements ActionListener {
	...
	public CustActionListener(Core core, DataUser frm, JButton btn) {
		this.core = core;
		this.frmDataUser = frm;
		this.btn = btn;
		mode = LOGIN;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		case SHOW_DATA_BARANG:
			...
			break;
		case SHOW_DATA_USER:
			if (core.frmDataUser == null) {
			} else {
				core.frmDataUser.dispose();
			}
			core.frmDataUser = new DataUser(core);
			core.frmDataUser.setVisible(true);
			break;
