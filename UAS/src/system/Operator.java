...
public class Operator {
	...
	public static ResultSet getListTransaksi(Connection con) {
		return select(con, "SELECT * FROM transaksi ORDER BY noTransaksi");
	}

	public static ResultSet getListDetilTransaksi(Connection con,
			int idTransaksi) {
		return select(con, "SELECT * FROM detilTransaksi WHERE noTransaksi="
				+ idTransaksi);
	}
	...
	public static boolean tambahBarang(Barang brg, Connection con) {
		return update(
				con,
				"INSERT INTO product " + "VALUES('" + brg.getId() + "','"
	...
	public static boolean hapusBarang(Barang brg, Connection con) {
		return update(con, "DELETE FROM product WHERE id_product='" + brg.getId()+"'");
	}
